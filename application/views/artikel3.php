...
<body  topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" background="latar.jpg">
  <div class="wrapper">
    ...
    <br>
      <div class="col-sm-12">
      <p align="center"><img src="<?php echo base_url();?>Asset/artikel3.jpg" class=class="img-fluid img-thumbnail" alt="FIF"></p>
      <div style="text-align: center;"><h5><strong> Penghargaan International Student Award kategori Highly Commended - Postgraduate Coursework</strong></h5>
          <div style="text-align: justify;"><p><h7>Bandung. Selamat kepada Juni Hezi Romansyah (Alumni Teknik Telekomunikasi) karna telah meraih penghargaan International Student Award kategori Highly Commended – Postgraduate Coursework di Adelaide, Australia. Juni Hezi Romansyah dan dua orang lainnya berhasil meraih predikat terbaik. mereka juga merupakan penerima beasiswa Australia Awards dari pemerintah Australia.
          <br> Juni Hezi Romansyah adalah alumni Jurusan Teknik Telekomunikasi, Fakultas Teknik Elektro di STT Telkom yang kini telah berganti nama menjadi Telkom University. Saat ini Juni Hezi Romansyah bekerja di PT. Telkom Indonesia dan sedang melanjutkan pendidikan masternya di Master of Business Administration (MBA) di Flinders University, Adelaide Australia sejak tahun 2017.
          <br> Info lebih lanjut dapat dilihat di http://aceh.tribunnews.com/2018/10/21/pemuda-aceh-raih-penghargaan-international-student-award-di-australia</h7></p>
          </div>
          <div class="btn-group">
