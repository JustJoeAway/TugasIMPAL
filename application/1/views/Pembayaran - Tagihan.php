...
<body  topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" background="latar.jpg">
  ...
  <div class="container">
    ...
    <div class="card" class="col-sm-10">
      <div class="col-sm-12">
      <div style="text-align: justify;"><p><h5><strong> Pembayaran Semester </strong></h5>
          <table class="table table-bordered">
            <thead>
              <tr>
                <th>Tahun Akademik dan Semester</th>
                <th>Tagihan</th>
            ...
            <tbody>
              <tr>
                ...
                <td>40.650.000
                  <div class="btn-group">
                    <button type="button" class="btn btn-sm btn-outline-secondary">Cetak Kwitansi</button>
                  </div>
                </td>
                <td> LUNAS </td>
              </tr>
          ...
          <div style="text-align: center;">
            <div class="btn-group">
              <button type="button" class="btn btn-sm btn-outline-secondary">Input Token Pembayaran</button>
            </div>
          </div>
          <br>
      </div>
